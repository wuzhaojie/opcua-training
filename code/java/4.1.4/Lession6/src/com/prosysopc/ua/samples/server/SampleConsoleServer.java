...
import com.prosysopc.ua.samples.sampletypes.ValveObjectType;
import com.prosysopc.ua.samples.sampletypes.server.ServerInformationModel;
import com.prosysopc.ua.samples.sampletypes.server.ValveObjectTypeNode;
...
public class SampleConsoleServer {
   ...
   */
  protected void loadInformationModels() throws StatusException {
    ...
    try {
      ...
      server.getAddressSpace().loadModel(
          new File("E:\\src\\3\\opcua-training\\code\\java\\4.1.4\\Lession6\\src\\com\\prosysopc\\ua\\samples\\SampleTypes.xml").toURI());
