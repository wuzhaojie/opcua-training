...
import static com.prosysopc.ua.core.StatusCodes.Bad_ApplicationSignatureInvalid;
import static com.prosysopc.ua.utils.EndpointUtil.select;
...
import com.prosysopc.ua.core.ServerOnNetwork;
...
import com.prosysopc.ua.transport.ServiceChannel;
import com.prosysopc.ua.transport.TransportChannelSettings;
import com.prosysopc.ua.transport.UriUtil;
import com.prosysopc.ua.transport.UriUtil.MessageFormat;
import com.prosysopc.ua.transport.https.HttpsClient;
import com.prosysopc.ua.transport.https.HttpsClientSecureChannel;
...
import com.prosysopc.ua.transport.tcp.io.SecureChannelTcp;
...
public class Client {
	 ...
	 * @throws ServiceResultException if errror
	 */
...
//		}
	 ...
	 * @throws ServiceResultException if error
	 */
	public ServiceChannel createServiceChannel(String connectUrl, String endpointUri, SecurityMode mode, Cert remoteCertificate) throws ServiceResultException {
	 ...
	 *
	 * @param endpointConfiguration a {@link EndpointConfiguration} object.
	 */
