...
import com.prosysopc.ua.transport.ConnectionMonitor.ConnectListener;
import com.prosysopc.ua.transport.ServerConnection;
import com.prosysopc.ua.transport.ServerConnection.SecureChannelListener;
...
public class DebugLogger implements ConnectListener, SecureChannelListener, StateListener<CloseableObjectState> {
	 ...
	 *
	 * @param sender a {@link IStatefulObject} object.
	 * @param oldState a {@link CloseableObjectState} object.
	 * @param newState a {@link CloseableObjectState} object.
	 */
