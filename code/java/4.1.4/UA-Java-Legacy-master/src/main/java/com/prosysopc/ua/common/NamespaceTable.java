...
public class NamespaceTable extends UriTable {
	 ...
	 *
	 * @param nodeId1 a {@link NodeId} object.
	 * @param nodeId2 a {@link NodeId} object.
	 ...
	 *
	 * @param nodeId a {@link NodeId} object.
	 * @param expandedNodeId a {@link ExpandedNodeId} object.
	 * @return true if the nodes are in the same name space
	 */
	 ...
	 * checked for the NamespaceUri or Index depending on which is used.
	 *
	 * @param expandedNodeId1 a {@link ExpandedNodeId} object.
	 * @param expandedNodeId2 a {@link ExpandedNodeId} object.
	 * @return true if the nodes are in the same name space
	 */
