...
public class TransportChannelSettings implements Cloneable {
	 ...
	 *
	 * @param description a {@link EndpointDescription} object.
	 * @param configuration a {@link EndpointConfiguration} object.
	 * @param clientCertificate a {@link Cert} object.
	 * @param privateKey a {@link PrivKey} object.
	 * @param certificateValidator a {@link CertificateValidator} object.
	 * @param namespaceUris (optional)
	 * @throws RuntimeServiceResultException if any.
	 */
	public TransportChannelSettings(
			EndpointDescription description,
			EndpointConfiguration configuration,
	 ...
	 * @param certValidator a {@link CertificateValidator} object.
	 ...
	 * <p>readFrom.</p>
	 *
	 * @param tcs a {@link TransportChannelSettings} object.
	 */
	 ...
	 *
	 * @param namespaceUris a {@link NamespaceTable} object.
	 */
