...
import com.prosysopc.ua.transport.security.HttpsSecurityPolicy;
...
import com.prosysopc.ua.transport.tcp.io.ITransportChannel;
...
public class HttpsClient implements ITransportChannel {
	 ...
	 *
	 * @param serviceRequest a {@link ServiceRequest} object.
