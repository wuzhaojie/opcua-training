...
import com.prosysopc.ua.transport.security.CertValidatorTrustManager;
...
public class HttpsServer extends AbstractState<CloseableObjectState, ServiceResultException> implements EndpointServer {
	 ...
	 *
	 * @param validators a {@link CertificateValidator} object.
...
//			else endpointId = "*"+endpointId;
	 ...
	 *
	 * @return an array of {@link HttpsServer.SocketHandle} objects.
	 */
