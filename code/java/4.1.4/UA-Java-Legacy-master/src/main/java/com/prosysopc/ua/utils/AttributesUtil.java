...
import com.prosysopc.ua.core.Attributes;
import com.prosysopc.ua.core.NodeClass;
...
public class AttributesUtil {
     ...
     * <p>isValid.</p>
     *
     * @param attributeId a {@link UnsignedInteger} object.
     * @return a boolean.
     */
     ...
     *
     * @param nodeClass a {@link NodeClass} object.
     * @param attributeId a {@link UnsignedInteger} object.
    ...
    public static boolean isValid(NodeClass nodeClass, UnsignedInteger attributeId) {
    	...
    	if (attributeId.equals(Attributes.Value) || attributeId.equals(Attributes.DataType) || attributeId.equals(Attributes.ValueRank)) {
    		return (ordinalNodeClass & (NodeClass.VariableType.ordinal()| NodeClass.Variable.ordinal())) != 0;
			
		}
    	
    	if (attributeId.equals(Attributes.IsAbstract)) {
			return (ordinalNodeClass & (NodeClass.VariableType.ordinal() |
					NodeClass.ObjectType.ordinal() | NodeClass.DataType.ordinal() | NodeClass.ReferenceType.ordinal())) != 0;
		}

    	if (attributeId.equals(Attributes.Symmetric) || attributeId.equals(Attributes.InverseName)) {
			return (ordinalNodeClass & NodeClass.ReferenceType.ordinal()) != 0;
		}

    	if (attributeId.equals(Attributes.ContainsNoLoops)) {
			return (ordinalNodeClass & NodeClass.View.ordinal()) != 0;
		}
    	
    	if (attributeId.equals(Attributes.EventNotifier)) {
			return (ordinalNodeClass & (NodeClass.Object.ordinal() | NodeClass.View.ordinal())) != 0;
		}
    	...
    	if (attributeId.equals(Attributes.AccessLevel) || attributeId.equals(Attributes.UserAccessLevel) || attributeId.equals(Attributes.MinimumSamplingInterval) || 
			...
			return (ordinalNodeClass & NodeClass.Variable.ordinal()) != 0;
		}
    	if( attributeId.equals(Attributes.ArrayDimensions)){
    		return (ordinalNodeClass & (NodeClass.Variable.ordinal() |
					NodeClass.VariableType.ordinal())) != 0;
    	}
                
    	if (attributeId.equals(Attributes.Executable) || attributeId.equals(Attributes.UserExecutable)) {
			return (ordinalNodeClass & NodeClass.Method.ordinal()) != 0;
		}
	 ...
	 * <p>toString.</p>
	 *
	 * @param value a {@link UnsignedInteger} object.
