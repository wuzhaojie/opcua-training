...
import com.prosysopc.ua.core.AnonymousIdentityToken;
...
import com.prosysopc.ua.core.UserNameIdentityToken;
import com.prosysopc.ua.core.UserTokenPolicy;
import com.prosysopc.ua.core.UserTokenType;
...
public class EndpointUtil {
	 ...
	 * <p>select.</p>
	 *
	 * @param endpoints an array of {@link EndpointDescription} objects.
	 ...
	 * <p>select.</p>
	 *
	 * @param searchSet an array of {@link EndpointDescription} objects.
	 ...
	 *
	 * @param searchSet an array of {@link EndpointDescription} objects.
	 * @param mode a {@link MessageSecurityMode} object.
	 ...
	 *
	 * @param searchSet an array of {@link EndpointDescription} objects.
	 * @param policy a {@link SecurityPolicy} object.
	 * @return A subset of searchSet whose elements use given message security mode
	 */
	 ...
	 *
	 * @param ep a {@link EndpointDescription} object.
...
//				proto = parts[0].split(":")[0]; // // Use the proto parsed from URI, which should be fine, already
	 ...
	 * @param signatureData a {@link SignatureData} object.
	 * @return a {@link X509IdentityToken} object.
	 * @throws ServiceResultException if any.
	 */
...
//		return new byte[] {(byte)(value>>24), (byte)(value>>16), (byte)(value>>8), (byte)(value)};
	 ...
	 *
	 * @param userIdentityTokens an array of {@link UserTokenPolicy} objects.
	 * @return a boolean.
	 */
