...
import com.prosysopc.ua.utils.asyncsocket.ListenableServerSocketChannel.ServerSocketAcceptable;
...
public class AsyncServerSocket extends AbstractState<ServerSocketState, IOException> {
	 ...
	 * @param sel a {@link AsyncSelector} object.
	 ...
	 * <p>close.</p>
	 *
	 * @return a {@link AsyncServerSocket} object.
	 */
	 ...
	 * <p>addListener.</p>
	 *
	 * @param listener a {@link AsyncServerSocket.ConnectListener} object.
	 */
