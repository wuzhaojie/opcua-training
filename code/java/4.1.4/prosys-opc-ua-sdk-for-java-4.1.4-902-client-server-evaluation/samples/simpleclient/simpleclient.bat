...
if not exist %bindir%\com\prosysopc\ua\samples\client\SimpleClient.class %JAVA_HOME%\bin\javac -classpath %CP% %srcdir%\com\prosysopc\ua\samples\client\*.java 

%JAVA_HOME%\bin\java -classpath %bindir%;%CP% com.prosysopc.ua.samples.client.SimpleClient %1 %2 %3 %4 %5 %6 %7 %8 %9
